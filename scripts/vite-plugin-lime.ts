...
import { createLogger, Plugin, ResolvedConfig } from "vite";

export default function limePlugin(): Plugin {
...
function isInXMLComment(projectXML: string, index: number) {
...
function getHaxelibs(projectXML: string) {
